...
public class DefaultUIApplication {
    ...
    public void run(String pathToJSONFile, String objectParseToJSON) {

        JFrame frame = new JFrame("Rectangles JSON Test");
        frame.setSize(widthForm, heightForm);
        frame.setLocationRelativeTo(null);
        frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        RectangleForm form = new RectangleForm(new EventsApplication(pathToJSONFile, objectParseToJSON));

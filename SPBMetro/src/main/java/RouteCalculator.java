    ...
    public static double calculateDuration(List<Station> route) {
        ...
        if (routSize > 1) {
            ...
            for (int i = 0; i < routSize; i++) {
                ...
                if (i > 0) {
                    //сравнение линий текущей станции и предыдущий, если линии разные, то был переход, если нет то станция
                ...
                Все считается верно, потому что:
                1. Горьковская - станция отправления время не считается, далее едем...
                2. горьковская - невский проспект - 2.5 минуты
                3. невский проспект - гостиный двор - 3.5. минуты
                4. гостиный двор - василеостровская 2.5 минуты
                5. Василеостровская - приморская 2.5 минуты
                 */

...
public class BankAccountTest {
    ...
    private static final String notExpectedKomission = "Комиссия должна быть от 1 до 100%!";
    ...
    @Test
    @DisplayName("Метод take, проверка списания с комиссией")
    void takeTooMuchMoneyKomission() {
